...
# Negative amounts are purchases (draw down the balance);
# positive amounts are income/credits (increase the balance).
SEED_TRANSACTIONS = [
    ...
    ('ACME Corp payroll', 12, 6, 1450.00, 'Income'),
    ...
    ('ACME Corp payroll', 26, 6, 1450.00, 'Income'),
]
